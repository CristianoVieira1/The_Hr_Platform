...
@section('content')
    <section class="page__title p-relative d-flex align-items-center fix" data-background="assets/img/page-title/page-title-3.png" style="background-attachment: fixed;">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-5 offset-lg-1">
                    <div class="about__content wow fadeInRight" data-wow-delay=".4">
                        ...
                        <a href="https://calendly.com/hrplatform/consultation?month=2022-02" class="z-btn wow fadeInUp" data-wow-delay="1.2s">Contact us<i class="far fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-6">
                    <div class="achievement__content">
                        ...
                        <a href="https://calendly.com/hrplatform/consultation?month=2022-02" class="z-btn">Contact us</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-sm-6">
                            <div class="achievement__thumb m-img pl-30 text-right wow fadeInRight" data-wow-delay=".8s">
                                <img class="border-ra" src="assets/img/achievement/achievement-1.png" alt="achievement-1">
                            </div>
                        </div>
                        <div class="col-xl-5 col-sm-6 d-md-none d-lg-none d-xl-block wow fadeInRight" data-wow-delay="1s">
                            <div class="achievement__thumb w-img">
                                <img class="border-ra" src="assets/img/achievement/achievement-2.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
